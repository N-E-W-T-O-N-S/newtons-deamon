...
namespace NEWTONS.Core
{
    public class CuboidCollider : KonvexCollider
    {
        ...
        {
            float lengthX = Mathf.Abs((other.Center.x + other.KinematicBody.Position.x) - (Center.x + KinematicBody.Position.x));
            float lengthY = Mathf.Abs((other.Center.y + other.KinematicBody.Position.y) - (Center.y + KinematicBody.Position.y));
            float lengthZ = Mathf.Abs((other.Center.z + other.KinematicBody.Position.z) - (Center.z + KinematicBody.Position.z));
